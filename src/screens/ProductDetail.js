...
import { iconsLoaded, iconsMap } from '../utils/navIcons';
			...
			<View style={styles.addToCartContainer}>
				...
				{Platform.OS === 'ios' && config.applePay && (
					<View style={styles.inAppPaymentWrapper}>
						<InAppPayment navigator={navigator} onPress={this.handleApplePay} />
					</View>
				)}
